                    ...
                    <div class="col-md-10">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Student Examinations</h3>
                            </div>
                                          ...
                                          @foreach($results as $value)
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="actions">
                                                    <a  href='{{url("studentresults/{$value->exam_code}/{$value->tsc_no}")}}'><button class="btn btn-icon btn-info m-b-5" data-toggle="modal" data-target="edit" > <i class="ion-eye"></i> View </button></a>
