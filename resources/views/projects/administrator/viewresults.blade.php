                    ...
                    <div class="col-md-8">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Student Examination Performance</h3>
                            </div>
                            <div class="panel-body">
                                   <div class="row">
                             <div class="col-lg-6">
                                <button class="btn btn-info btn-sm" id="sa-title">Get Help</button>
                                           ...
                                           @foreach($student as $value)
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>{{$value->p_grade}}</td>
                                                    <td class="actions">
                                                    <a  href="#"><button class="btn btn-icon btn-info m-b-5" data-toggle="modal" data-target="edit" role="button" disabled="disabled"> <i class="ion-edit"></i> Edit </button></a>
