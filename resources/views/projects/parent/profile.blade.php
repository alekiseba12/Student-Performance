                  ...
                  <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading"><h3 class="panel-title">Parent Edit Details</h3></div>
                            <div class="panel-body">
                                <form role="form" action="{{route('parentdetails')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                  
                                         <div class="form-group col-md-4">
                                        <label for="admin No" class="col-lg-4 control-label">National ID</label>
                                        
                                        <input type="text" name="national_id" class="form-control" id="admin no" placeholder="Provide National ID" value="">
                                    </div>
                                         <div class="form-group col-md-4">
                                        ...
                                        <div class="form-group col-md-4">
                                        <label for="location" class="col-lg-4 control-label">Parental Type</label>
                                        
                                            <select id="address" name="parental" type="text" class="form-control" placeholder="Choose the parental">
                                                      
                                                        <option value="#">Select Parental Type</option>
                                      ...
                                      <div class="form-group col-md-4">
                                       ...
                                       <div class="form-group col-md-4">
                                        <label for="phone" class="col-lg-4 control-label">Admission </label>
                                        
                                        <input type="text" name="admin_no" class="form-control" id="phone number" placeholder=" Student Admission Number" value="">
                                    </div>
