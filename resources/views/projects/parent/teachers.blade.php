                    ...
                    <div class="col-md-10">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Student Subjects</h3>
                            </div>
                                           ...
                                           @foreach($subjects as $value)
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><img class="img-wrapper pull-left m-r-15" src="{{$value->profile}}" alt="" style="width:64px" class="br-radius"></td>
                                                    <td>{{$value->fullnames}}</td>
                                                    <td>{{$value->gender}}</td>
                                                    <td>{{$value->phone}}</td>
                                                    <td>{{$value->subject}}</td>
