                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Examination List</h3>
                            </div>
                            <div class="panel-body">
                                   <div class="row">
                                       <div class="col-sm-6">
                                        <div class="m-b-30">
                                        <a href="{{route('examForm')}}"><button  class="btn btn-primary waves-effect waves-light">Add New <i class="fa fa-plus"></i></button></a>
                                           </div>
                                          </div>
                                        </div>
                                        <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="actions">
                                                    <a  href='{{url("editexaminations/{$key->exam_code}")}}'><button class="btn btn-icon btn-info m-b-5" data-toggle="modal" data-target="edit" > <i class="fa fa-pencil-square-o"></i> </button></a>
                                                    <a href='{{url("deleteexamdetails/{$key->exam_code}")}}'><button class="btn btn-icon btn-danger m-b-5" onclick="return confirm('Are you sure want to delete this Examination?')"> <i class="ion-trash-a"></i> </button></a>
                                                </td>
