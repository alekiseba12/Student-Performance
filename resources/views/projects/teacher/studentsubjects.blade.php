             ...
             @endif
                ...
                <div class="row">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading"><h3 class="panel-title">Student Subjects Details</h3></div>
                            <div class="panel-body">
                                <form role="form" action="{{route('insertstudentsubjects')}}" method="post">
                                    @csrf
                                    <div class="form-group">
                                        <label for="Admission">Admission No/Birth No</label>
                                        <input type="text" class="form-control" name="admin_no" id="Admission" placeholder="Enter Admission/Birth No" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Subject</label>
                                           <select class="form-control" placeholder="Choose the subject" name="subject_id" required="required">
                                                        @if(count($subjects)>0)
                                      ...
                                      <div class="form-group">
                                        <label for="exampleInputPassword1">Stream/Form</label>
                                           <select class="form-control" placeholder="Choose the subject" name="stream_id" required="required">
                                                        @if(count($streams)>0)
