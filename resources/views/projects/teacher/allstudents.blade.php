                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                   <div class="row">
                                       <div class="col-sm-6">
                                        <div class="m-b-30">
                                        <a href="{{route('studentdashboard')}}"><button  class="btn btn-success waves-effect waves-light">Add Student <i class="fa fa-plus"></i></button></a>
                                           </div>
                                          </div>
                                        </div>
                                        <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                     ...
                                                     <td>{{$student->parental}}</td>
                                                    <td>{{$student->stream}}</td>
                                                    <td>{{$student->academic_year}}</td>
                                                    <td>{{$student->kcpe_marks}}</td>
                                                      
                                                    <td class="actions">
                                                    <a  href='{{url("getstudentdetails/{$student->admin_no}")}}'><button class="btn btn-icon btn-info m-b-5" data-toggle="modal" data-target="edit" > <i class="fa fa-pencil-square-o"></i> </button></a>
                                                    <a href='{{url("deletestudentdetails/{$student->admin_no}")}}'><button class="btn btn-icon btn-danger m-b-5" onclick="return confirm('Are you sure want to delete this student?')"> <i class="ion-trash-a"></i> </button></a>
                                                </td>
